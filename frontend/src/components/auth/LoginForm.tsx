      ...
      <div className="w-full max-w-md space-y-8 bg-white p-8 rounded-2xl shadow-xl border border-slate-100">
        ...
        <form className="mt-8 space-y-6" onSubmit={handleLogin}>
          ...
          <div className="space-y-4">
            <FormInput name="username" type="text" placeholder="Username" icon={User} required />
            <FormInput name="password" type="password" placeholder="Password" icon={Lock} required />
          </div>
          <button
            disabled={loading}
